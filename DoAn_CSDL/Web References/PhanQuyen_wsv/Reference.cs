...
namespace DoAn_CSDL.PhanQuyen_wsv {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="PhanQuyen_wsvSoap", Namespace="http://tempuri.org/")]
    public partial class PhanQuyen_wsv : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public PhanQuyen_wsv() {
            this.Url = global::DoAn_CSDL.Properties.Settings.Default.DoAn_CSDL_PhanQuyen_wsv_PhanQuyen_wsv;
        ...
        public API_ResultOfBoolean Create(string loginCode, tbl_PhanQuyen obj) {
        ...
        /// <remarks/>
        public void CreateAsync(string loginCode, tbl_PhanQuyen obj) {
            this.CreateAsync(loginCode, obj, null);
        }
        
        /// <remarks/>
        public void CreateAsync(string loginCode, tbl_PhanQuyen obj, object userState) {
        ...
        public API_ResultOfBoolean Edit(string loginCode, tbl_PhanQuyen obj) {
        ...
        /// <remarks/>
        public void EditAsync(string loginCode, tbl_PhanQuyen obj) {
            this.EditAsync(loginCode, obj, null);
        }
        
        /// <remarks/>
        public void EditAsync(string loginCode, tbl_PhanQuyen obj, object userState) {
        ...
        public API_ResultOfListOfListCombobox_ettOfInt32 GetListCombobox(string loginCode) {
        ...
        /// <remarks/>
        public void GetListComboboxAsync(string loginCode) {
            this.GetListComboboxAsync(loginCode, null);
        }
        
        /// <remarks/>
        public void GetListComboboxAsync(string loginCode, object userState) {
            ...
            this.InvokeAsync("GetListCombobox", new object[] {
                        loginCode}, this.GetListComboboxOperationCompleted, userState);
        }
        ...
        public API_ResultOfListOfview_PhanQuyen SearchPaging(string loginCode, string searchValue, EnumSearchType searchType, int curPage, int pageSize, EnumOrderBy orderBy, bool isDescending) {
            object[] results = this.Invoke("SearchPaging", new object[] {
                        ...
                        orderBy,
                        isDescending});
            return ((API_ResultOfListOfview_PhanQuyen)(results[0]));
        }
        
        /// <remarks/>
        public void SearchPagingAsync(string loginCode, string searchValue, EnumSearchType searchType, int curPage, int pageSize, EnumOrderBy orderBy, bool isDescending) {
            this.SearchPagingAsync(loginCode, searchValue, searchType, curPage, pageSize, orderBy, isDescending, null);
        }
        
        /// <remarks/>
        public void SearchPagingAsync(string loginCode, string searchValue, EnumSearchType searchType, int curPage, int pageSize, EnumOrderBy orderBy, bool isDescending, object userState) {
        ...
        public API_ResultOfview_PhanQuyen GetByID(string loginCode, int id) {
            object[] results = this.Invoke("GetByID", new object[] {
                        loginCode,
                        id});
            return ((API_ResultOfview_PhanQuyen)(results[0]));
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://tempuri.org/")]
    public partial class API_ResultOfview_PhanQuyen {
        
        private view_PhanQuyen dataField;
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://tempuri.org/")]
    public partial class API_ResultOfListOfview_PhanQuyen {
    ...
    public partial class SearchPagingCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public API_ResultOfListOfview_PhanQuyen Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((API_ResultOfListOfview_PhanQuyen)(this.results[0]));
            }
        }
    }
    ...
    public partial class GetByIDCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public API_ResultOfview_PhanQuyen Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((API_ResultOfview_PhanQuyen)(this.results[0]));
            }
        }
    }
}
