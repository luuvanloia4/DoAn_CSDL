    ...
    public class PhieuXuatController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> SearchPaging()
        {
            ...
            try
            {
                ...
                int chID = SharedFunction.ParseID(formData.Get("CuaHangID"));
                //
                ...
                PhieuXuat.PhieuXuat_wsv px_wsv = new PhieuXuat.PhieuXuat_wsv();
                var rs = px_wsv.SearchPaging(loginCode, htID, chID, status, startTime, endTime, searchValue, (PhieuXuat.EnumSearchType)searchType, curPage, pageSize, (PhieuXuat.EnumOrderBy)orderBy, isDes);
        ...
        [HttpPost]
        public async Task<HttpResponseMessage> GetListCTPX()
        {
            ServicePointManager.ServerCertificateValidationCallback = (senderX, certificate, chain, sslPolicyErrors) => { return true; };
            if (!Request.Content.IsMimeMultipartContent())
            {
            ...
            try
            {
                ...
                PhieuXuat.PhieuXuat_wsv px_wsv = new PhieuXuat.PhieuXuat_wsv();
                var rs = px_wsv.GetListCTPX(loginCode, id);
        ...
        //Chuyen trang thai
        [HttpPost]
        public async Task<HttpResponseMessage> PheDuyet()
        {
            ServicePointManager.ServerCertificateValidationCallback = (senderX, certificate, chain, sslPolicyErrors) => { return true; };
            if (!Request.Content.IsMimeMultipartContent())
            {
            ...
            try
            {
                ...
                PhieuXuat.PhieuXuat_wsv px_wsv = new PhieuXuat.PhieuXuat_wsv();
                var rs = px_wsv.PheDuyet(loginCode, id);
        ...
        [HttpPost]
        public async Task<HttpResponseMessage> HoanThanh()
        {
            ServicePointManager.ServerCertificateValidationCallback = (senderX, certificate, chain, sslPolicyErrors) => { return true; };
            if (!Request.Content.IsMimeMultipartContent())
            {
            ...
            try
            {
                ...
                PhieuXuat.PhieuXuat_wsv px_wsv = new PhieuXuat.PhieuXuat_wsv();
                var rs = px_wsv.HoanThanh(loginCode, id);
        ...
        public async Task<HttpResponseMessage> Delete()
        {
            ...
            try
            {
                ...
                PhieuXuat.PhieuXuat_wsv px_wsv = new PhieuXuat.PhieuXuat_wsv();
                var rs = px_wsv.Delete(loginCode, id);
        ...
        public async Task<HttpResponseMessage> DeleteList()
        {
            ...
            try
            {
                ...
                PhieuXuat.PhieuXuat_wsv px_wsv = new PhieuXuat.PhieuXuat_wsv();
                var rs = px_wsv.DeleteList(loginCode, listID.ToArray());
